...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.grup_ruta = QtWidgets.QGroupBox(self.tab_descarga_datos)
        self.grup_ruta.setGeometry(QtCore.QRect(10, 160, 621, 41))
        self.grup_ruta.setTitle("")
        self.grup_ruta.setObjectName("grup_ruta")
        self.directorio_g_input = QtWidgets.QLineEdit(self.grup_ruta)
        self.directorio_g_input.setEnabled(False)
        self.directorio_g_input.setGeometry(QtCore.QRect(100, 10, 451, 20))
        self.directorio_g_input.setObjectName("directorio_g_input")
        self.directorio_g_text = QtWidgets.QLabel(self.grup_ruta)
        self.directorio_g_text.setGeometry(QtCore.QRect(16, 10, 71, 21))
        self.directorio_g_text.setObjectName("directorio_g_text")
        self.btn_directorio_excel = QtWidgets.QPushButton(self.grup_ruta)
        self.btn_directorio_excel.setGeometry(QtCore.QRect(570, 10, 41, 21))
        ...
        self.grup_op_busqueda.setGeometry(QtCore.QRect(10, 10, 971, 141))
        ...
        self.grup_individual.setGeometry(QtCore.QRect(10, 40, 411, 91))
        ...
        self.btn_buscar_datos = QtWidgets.QPushButton(self.grup_individual)
        self.btn_buscar_datos.setGeometry(QtCore.QRect(160, 50, 131, 31))
        self.btn_buscar_datos.setObjectName("btn_buscar_datos")
        self.desc_grupo2 = QtWidgets.QGroupBox(self.grup_op_busqueda)
        self.desc_grupo2.setGeometry(QtCore.QRect(430, 40, 531, 91))
        self.desc_grupo2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.desc_grupo2.setTitle("")
        ...
        self.rang_fecha1_dia_input.setGeometry(QtCore.QRect(50, 50, 21, 21))
        ...
        self.btn_buscar_datos_rang.setGeometry(QtCore.QRect(370, 50, 101, 31))
        ...
        self.rang_fecha1_mes_input.setGeometry(QtCore.QRect(80, 50, 21, 21))
        ...
        self.rang_fecha1_anno_input.setGeometry(QtCore.QRect(110, 50, 51, 21))
        ...
        self.rang_fecha2_dia_input.setGeometry(QtCore.QRect(230, 50, 31, 21))
        ...
        self.rang_fecha2_dia_input_2.setGeometry(QtCore.QRect(270, 50, 31, 21))
        ...
        self.rang_fecha2_anno_input.setGeometry(QtCore.QRect(310, 50, 51, 21))
        ...
        self.rang_fecha2_text.setGeometry(QtCore.QRect(180, 50, 41, 21))
